...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var table_columns = ['', 'group_id', 'name', 'description', ''];
        ...
        enable_cleanup(<?php echo json_encode(lang("groups_confirm_cleanup"));?>);
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li>
                                <?php echo anchor("$controller_name/categories",
                                                  ...
                                                  array('class' => '', 'title' => lang('groups_manage_categories')));
                                ?>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <?php echo anchor("$controller_name/manage_tags",
                                                  ...
                                                  array('class' => '', 'title' => lang('groups_manage_tags')));
                                ?>
                            </li>
                            <?php } ?>
                            ...
                            <li>
                                ...
                                array('class' => '',
                                    'title' => lang('groups_count_inventory')));
                                ?>
                            </li>
                            <?php endif ?>
                            ...
                            <li>
                                <?php echo anchor("$controller_name/cleanup",
                                                  ...
                                                  array('id' => 'cleanup', 'class' => '', 'title' => lang("groups_cleanup_old_groups")));
                                ?>
                            </li>
                            <?php endif; ?>
                        </ul>
