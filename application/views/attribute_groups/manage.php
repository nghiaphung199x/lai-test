...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        enable_cleanup(<?php echo json_encode(lang("attribute_groups_confirm_cleanup"));?>);
...
<div class="manage_buttons">
    <div class="manage-row-options hidden">
        <div class="email_buttons attribute_groups">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="buttons-list attribute_groups-buttons">
                <div class="pull-right-btn">

                    <?php if ($this->Employee->has_module_action_permission('attribute_sets', 'add_update', $this->Employee->get_logged_in_employee_info()->person_id)) :?>
                    <?php echo anchor("attribute_sets", '<span class="">' . lang('attribute_sets_manage') . '</span>', array('class' => 'btn btn-primary btn-lg', 'title' => lang($controller_name . '_new'))); ?>
                    <?php endif ?>
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li>
                                <?php echo anchor("$controller_name/categories",
                                                  '<span class="">' . lang("attribute_groups_manage_categories") . '</span>',
                                                  array('class' => '', 'title' => lang('attribute_groups_manage_categories')));
                                ?>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <?php echo anchor("$controller_name/manage_tags",
                                                  '<span class="">' . lang("attribute_groups_manage_tags") . '</span>',
                                                  array('class' => '', 'title' => lang('attribute_groups_manage_tags')));
                                ?>
                            </li>
                            <?php } ?>
                            ...
                            <li>
                                ...
                                '<span class="">' . lang("attribute_groups_count_inventory") . '</span>',
                                array('class' => '',
                                    'title' => lang('attribute_groups_count_inventory')));
                                ?>
                            </li>
                            <?php endif ?>
                            ...
                            <li>
                                <?php echo anchor("$controller_name/cleanup",
                                                  '<span class="">' . lang("attribute_groups_cleanup_old_attribute_groups") . '</span>',
                                                  array('id' => 'cleanup', 'class' => '', 'title' => lang("attribute_groups_cleanup_old_attribute_groups")));
                                ?>
                            </li>
                            <?php endif; ?>
                        </ul>
