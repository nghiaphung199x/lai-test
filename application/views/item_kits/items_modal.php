	...
	<div class="modal-content">
		...
		<div class="modal-body nopadding">			
			<table class="table table-bordered table-hover table-striped">
				...
				<tr> <td><?php echo lang('common_unit_price'); ?></td> <td> <?php echo (isset($item_kit_info->unit_price) && $item_kit_info->unit_price != '') ? to_currency($item_kit_info->unit_price, 10) : lang('common_none'); ?></td></tr>
				<?php 
