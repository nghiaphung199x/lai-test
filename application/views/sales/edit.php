			...
			<div class="panel-body">
				...
				<div class="form-group">	
					...
					<div class="col-sm-9 col-md-3 col-lg-3 sale-s">
						...
						<?php if (!$store_account_charge && !$this->config->item('enable_customer_loyalty_system')) { ?>
...
<?php } else {?>
	...
	<div class="panel panel-piluku">
		<div class="panel-heading">
		<h1 class="text-danger"><?php echo lang('common_error'); ?></h1>
	<p><?php echo lang('sales_cannot_edit_store_account_payment'); ?></p>
	</div>
</div>
</div>
<?php } ?>
