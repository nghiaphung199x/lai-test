...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var table_columns = ['', 'department_id', 'name', 'description', ''];
        ...
        enable_cleanup(<?php echo json_encode(lang("departments_confirm_cleanup"));?>);
...
<div class="manage_buttons">
    <div class="manage-row-options hidden">
        <div class="email_buttons departments">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="buttons-list departments-buttons">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li>
                                <?php echo anchor("$controller_name/categories",
                                                  '<span class="">' . lang("departments_manage_categories") . '</span>',
                                                  array('class' => '', 'title' => lang('departments_manage_categories')));
                                ?>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <?php echo anchor("$controller_name/manage_tags",
                                                  '<span class="">' . lang("departments_manage_tags") . '</span>',
                                                  array('class' => '', 'title' => lang('departments_manage_tags')));
                                ?>
                            </li>
                            <?php } ?>
                            ...
                            <li>
                                ...
                                '<span class="">' . lang("departments_count_inventory") . '</span>',
                                array('class' => '',
                                    'title' => lang('departments_count_inventory')));
                                ?>
                            </li>
                            <?php endif ?>
                            ...
                            <li>
                                <?php echo anchor("$controller_name/cleanup",
                                                  '<span class="">' . lang("departments_cleanup_old_departments") . '</span>',
                                                  array('id' => 'cleanup', 'class' => '', 'title' => lang("departments_cleanup_old_departments")));
                                ?>
                            </li>
                            <?php endif; ?>
                        </ul>
