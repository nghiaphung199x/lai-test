...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        enable_cleanup(<?php echo json_encode(lang("attributes_confirm_cleanup"));?>);
...
<div class="manage_buttons">
    <div class="manage-row-options hidden">
        <div class="email_buttons attributes">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="buttons-list attributes-buttons">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li>
                                <?php echo anchor("$controller_name/categories",
                                                  '<span class="">' . lang("attributes_manage_categories") . '</span>',
                                                  array('class' => '', 'title' => lang('attributes_manage_categories')));
                                ?>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                <?php echo anchor("$controller_name/manage_tags",
                                                  '<span class="">' . lang("attributes_manage_tags") . '</span>',
                                                  array('class' => '', 'title' => lang('attributes_manage_tags')));
                                ?>
                            </li>
                            <?php } ?>
                            ...
                            <li>
                                ...
                                '<span class="">' . lang("attributes_count_inventory") . '</span>',
                                array('class' => '',
                                    'title' => lang('attributes_count_inventory')));
                                ?>
                            </li>
                            <?php endif ?>
                            ...
                            <li>
                                <?php echo anchor("$controller_name/cleanup",
                                                  '<span class="">' . lang("attributes_cleanup_old_attributes") . '</span>',
                                                  array('id' => 'cleanup', 'class' => '', 'title' => lang("attributes_cleanup_old_attributes")));
                                ?>
                            </li>
                            <?php endif; ?>
                        </ul>
