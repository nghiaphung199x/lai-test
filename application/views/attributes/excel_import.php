	...
	<div class="col-md-12">
		<div class="panel panel-piluku">
			<div class="panel-heading">
				...
				<?php echo form_open_multipart('attributes/do_excel_import/',array('id'=>'giftcard_form','class'=>'form-horizontal')); ?>
				<h3><?php echo lang('common_step_1'); ?>: </h3>
				<p><?php echo lang('attributes_step_1_desc'); ?></p>
				
				<ul class="list-inline">
					<li>
						<a class="btn btn-green btn-sm " href="<?php echo site_url('attributes/excel'); ?>"><?php echo lang('attributes_new_items_import'); ?></a>
					</li>
					<li>
						<?php echo lang('common_or');?>
					</li>
					<li>
						<a class="btn btn-green btn-sm " href="<?php echo site_url('attributes/excel_export'); ?>"><?php echo lang('attributes_update_items_import'); ?></a>
					</li>
				</ul>
					
				<h3><?php echo lang('common_step_2'); ?>: </h3>
				<p><?php echo lang('attributes_step_2_desc'); ?></p>
