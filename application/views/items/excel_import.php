        ...
        <div class="panel panel-piluku">
            ...
            <div class="panel-body">
                ...
                <div class="clearfix">
                    ...
                    <ul class="list-inline item_import">
                        <li>
                            <a class="btn btn-green btn-sm "
                               href="<?php echo site_url('items/excel'); ?>"><?php echo lang('items_new_items_import'); ?></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="btn btn-green btn-sm "
                               href="<?php echo site_url('items/excel_export'); ?>"><?php echo lang('items_update_items_import'); ?></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="clearfix">
                    ...
                    <p><?php echo lang('common_items_import_note'); ?></p>
