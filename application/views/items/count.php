						...
						<tbody>
							<?php foreach($counts as $count_row) { ?>
								<tr class="text-center">
									...
									<td><a href="#" id="count_<?php echo $count_row['id']; ?>" class="xeditable" data-type="text" data-pk="<?php echo $count_row['id']; ?>" data-name="comment" data-url="<?php echo site_url('items/edit_count'); ?>" data-title="<?php echo H(lang('items_edit_comment')); ?>"><?php echo $count_row['comment'] ? H($count_row['comment']) : 'None'; ?></a></td>
