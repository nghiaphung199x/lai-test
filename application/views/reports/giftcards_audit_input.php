...
$(document).ready(function()
{
	...
	$("#generate_report").click(function()
	{
		...
		{
			window.location = window.location+'/'+$("#report_date_range_simple option:selected").val() + '/'+encodeURIComponent(giftcard_number)+'/'+export_excel;
		}
		else
		{
			...
			window.location = window.location+'/'+start_date + '/'+ end_date + '/'+encodeURIComponent(giftcard_number)+'/'+ export_excel;
		}
	});
