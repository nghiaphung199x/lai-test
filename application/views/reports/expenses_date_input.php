...
<div id="content-header">
	<h1><i class="ion-erlenmeyer-flask"></i>  <?php echo lang('reports_report_input'); ?></h1> 
</div>
				...
				<div class="widget-content nopadding"><?php
					...
					<form action="" class="form-horizontal form-horizontal-mobiles">
						...
						<div id='report_date_range_complex'>
							...
							<div class="form-group">
								<?php echo form_label(lang('reports_employee_type').' :', 'reports_employee_type_label', array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?> 
								<div class="col-sm-9 col-md-9 col-lg-10">
									<?php echo form_dropdown('employee_type',array( 'sale_person' => lang('reports_sale_person'), 'logged_in_employee' => lang('common_logged_in_employee')), 'sale_person', 'id="employee_type" class="input-medium"'); ?>
								</div>
							</div>
