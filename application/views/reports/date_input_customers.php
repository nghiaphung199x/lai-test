				...
				<form class="form-horizontal form-horizontal-mobiles">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-3 col-lg-2">
							...
							<label for="simple_radio" class="report_label"><span></span></label>	
...
<script type="text/javascript" language="javascript">
	$(document).ready(function()
	{
		...
		{		
			...
			{
				window.location = window.location+'/'+$("#report_date_range_simple option:selected").val() + '/'+sale_type+'/'+total_spent_condition+'/'+total_spent_amount;
			}
			else
			{
				...
				window.location = window.location+'/'+start_date + '/'+ end_date + '/'+sale_type+'/'+total_spent_condition+'/'+total_spent_amount;
			}
		});
