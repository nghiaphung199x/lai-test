	...
	<div class="col-md-12">
		<div class="panel panel-piluku">
			<div class="panel-heading">
				...
				<sup><?php echo lang('reports_date_range'); ?></sup>
			</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-md-2 col-lg-2">
						...
						<?php if (isset($search_suggestion_url)) {?>
							...
							?>									
						<?php } else { ?>
							<?php echo form_dropdown('specific_input_data',$specific_input_data, '', 'id="specific_input_data" class=""'); ?>
						<?php } ?>
					</div>
				</div>
...
<script type="text/javascript" language="javascript">
	$(document).ready(function()
	{
		...
		$("#generate_report").click(function()
		{
			...
			{
				window.location = window.location+'/'+$("#report_date_range_simple option:selected").val()+ '/' + specific_id + '/' + sale_type + '/' + employee_type + '/' + export_excel;
			}
			else
			{
				...
				window.location = window.location+'/'+start_date + '/'+ end_date + '/' + specific_id + '/' + sale_type + '/' + employee_type + '/'+ export_excel;
			}
		});
