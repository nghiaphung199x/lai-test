...
class Detailed_expenses extends Report
{
	...
	public function getDataColumns()
	{
		...
		, array('data'=>lang('common_note'), 'align'=> 'left')
		);
	...
	public function getData()
	{
		...
		$this->db->select('locations.name as location_name, categories.name as category, expenses.*, CONCAT(recv.last_name, ", ", recv.first_name) as employee_recv, CONCAT(appr.last_name, ", ", appr.first_name) as employee_appr', false);
