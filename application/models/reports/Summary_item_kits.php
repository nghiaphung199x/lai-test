...
class Summary_item_kits extends Report
{
	...
	{
		$this->db->select('item_kits.item_kit_id,name, sum(quantity_purchased) as quantity_purchased, sum(subtotal) as subtotal, sum(total) as total, sum(tax) as tax, sum(profit) as profit', false);
