...
<div id="pdf_content">
	...
	<div id="pdf_title" class="clb">
		<p>Phiếu trả hàng nhà cung cấp</p>
	</div>

	<div id="pdf_customer">
		<p>Họ tên nhà cung cấp: <?php if ($customer) { ?> <span><?php echo $customer; ?></span> <?php } ?></p>
		<p>Ghi chú: </p>
		...
		<table id="pdf_tbl_items" class="w100 table">
			<tbody>
				...
				<?php } ?>
                                ...
                                <tr>
                                    <td class="border-bottom text-bold" colspan="8"><?php echo lang('common_total_money').': '; echo NumberFormatToCurrency($total_money); ?></td>
				</tr>
					...
					?>
					<tr>
                                            <td class="border-bottom border-top text-bold" colspan="8"><?php echo lang('common_tax').': '; echo NumberFormatToCurrency(abs($total_tax)); ?></td>
					</tr>
				<?php }else {?>
				...
				<?php } ?>
                                <tr>
                                    <td class="border-bottom border-top text-bold" colspan="8"><?php echo lang('common_total').': '; echo $this->config->item('round_cash_on_sales') && $is_sale_cash_payment ? NumberFormatToCurrency(round_to_nearest_05(abs($total))) : NumberFormatToCurrency(abs($total)); ?></td>
				</tr>             
          ...
          break;
				...
				<tr>
						...
						<?php echo $payment['card_issuer']. ': '.$payment['truncated_card'].': '; 
                                                        ...
                                                        echo 'cash là : '.$total_money_cash.'<br/>';
                                                ?>
					<?php } else { ?>
	...
	<div>
            <p>Số tiền viết bằng chữ: <span><?php echo ($total_money_cash);?></span></p>
	</div>
