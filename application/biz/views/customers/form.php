	...
	<div class="col-md-12">
		...
		<?php } ?>
			...
			<div class="panel-body">
				...
				<div class="form-group">	
					<?php echo form_label(lang('customers_company_manage_name').' :', 'company_manage_name',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
					<div class="col-sm-9 col-md-9 col-lg-10">
					<?php echo form_input(array(
						'name'=>'company_manage_name',
						'id'=>'company_manage_name',
						'class'=>'form-control',
						'value'=>$person_info->company_manage_name)
						);?>
					</div>
				</div>
				
				<div class="form-group">
					<?php echo form_label(lang('customers_company_birth_date').' :', 'company_birth_date',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
					<div class="col-sm-9 col-md-9 col-lg-10">
					<?php echo form_input(array(
						'class'=>'form-control datepicker',
						'name'=>'company_birth_date',
						'type'=>'text',
						'id'=>'company_birth_date',
						'value'=>$person_info->company_birth_date != '1950-01-01' ? date(get_date_format(),strtotime($person_info->birth_date != ''?$person_info->company_birth_date: date('d-m-Y'))):'')
						);?>
					</div>
				</div>
				...
				<div class="form-group">	
					<?php echo form_label(lang('customers_code_tax').' :', 'code_tax',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
					<div class="col-sm-9 col-md-9 col-lg-10">
					<?php echo form_input(array(
						'name'=>'code_tax',
						'id'=>'code_tax',
