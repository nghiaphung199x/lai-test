		...
		<div class="col-md-5">
			<?php echo form_open("$controller_name/search_sms",array('id'=>'search_form', 'autocomplete'=> 'off', 'class' => 'form-inline')); ?>
				<div class="search no-left-border">
					<input type="text" class="form-control" name ='search' id='search' value="<?php echo isset($search) ? H($search) : ''; ?>" placeholder="<?php echo lang('common_search'); ?> <?php echo lang('module_'.$controller_name .'_sms'); ?>"/>
				</div>
