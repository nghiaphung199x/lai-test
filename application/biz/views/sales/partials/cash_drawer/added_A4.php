...
<div id="pdf_content">
	...
	?>
		...
		<div class="fr w220px">
			...
			<p>
				Ngày: <span><?php echo date(get_date_format(), strtotime('now')); ?></span>
			</p>
		</div>
	</div>
...
<!-- 		<p>Có:</p> -->
	...
	<div id="pdf_customer" class="clb">
		<p>Người nộp tiền: <?php echo $employee->first_name . ' ' . $employee->last_name; ?></p>
		<p>Địa chỉ: <?php echo nl2br($this->Location->get_info_for_key('address', isset($override_location_id) ? $override_location_id : FALSE)); ?></p>
		<p>Lý do nộp: <?php echo $note; ?></p>
		<p>Số tiền: <?php echo NumberFormatToCurrency($amount); ?> <?php echo $this->config->item('currency_symbol'); ?></p>
		<p>
			Số tiền viết bằng chữ: <span><?php echo getStringNumber((int) $amount);?></span>
		</p>
	</div>
