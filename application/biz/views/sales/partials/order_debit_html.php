	...
	<div class="w100 clb">
		<table id="pdf_tbl_items" class="w100">
			<tbody>
				...
				<tr>
									<td class="border-bottom border-right border-top text-bold" colspan="2" style="text-align: left;">Số tiền đã đặt: </td>
									<td class="border-bottom border-left border-right border-top text-bold" colspan="1">5000.000</td>
									<td class="border-bottom border-top text-bold border-left border-right" colspan="5" style="border-left: none !important;">Tổng tiền hàng</td>
									<td class="border-bottom  border-top border-left  text-bold" colspan="1">500.000</td>
				</tr>
								<tr>
					<!--<td colspan="3"></td>-->
									<td colspan="8" class="border-bottom border-top border-right text-bold" >Tổng thuế:</td>
									<td class="border-bottom border-top  text-bold" style="border-left: none !important;" >0</td>
				</tr>
								<tr>
									<td colspan="8" class="border-bottom border-top border-right text-bold"  >Chiết khấu đơn hàng: </td>
									<td colspan="1" class="border-bottom border-top text-bold" style="border-left: none !important;" >0</td>
								</tr>
				<tr>
									<td colspan="8" class="border-top text-bold border-right" >Tổng cộng tiền thanh toán: 5.000.000</td>
									<td colspan="1" class="border-top text-bold" style="border-left: none !important;">5.000.000</td>
								</tr>
