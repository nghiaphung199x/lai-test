	...
	<div class="w100 clb">
		<table id="pdf_tbl_items" class="w100">
			<tbody>
				...
				<tr>
									<td class="border-bottom border-top text-bold" colspan="9">Tổng giá trị đơn hàng: 5000.000</td>
				</tr>
								<tr>
					<!--<td colspan="3"></td>-->
									<td colspan="9" class="border-bottom border-top text-bold" >Chiết khấu, giảm giá: 0% : 0</td>
				</tr>
								<tr>
									<td colspan="9" class="border-bottom border-top text-bold" >Tổng tiền phải trả: 5.000.000</td>
								</tr>
				<tr>
									<td colspan="9" class="border-bottom border-top text-bold" >Đã thanh toán: 5.000.000</td>
								</tr>
								<tr>
									<td colspan="9" class="border-bottom border-top text-bold" >Tiền trả lại cho khách: 5.000.000</td>
								</tr>
								<tr>
									<td colspan="9" class="border-top text-bold" >Tiền nợ tất cả: 0</td>
								</tr>
			</tbody>
		</table>
	</div>
