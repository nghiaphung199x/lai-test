		...
		<table id="pdf_tbl_items" class="w100 table">
			<tbody>
				...
				<?php } ?>
                                ...
                                <tr>
                                    <td class="border-bottom text-bold" colspan="9"><?php echo lang('common_total_money').': '; echo NumberFormatToCurrency($total_money); ?></td>
				</tr>
					...
					?>
					<tr>
                                            <td class="border-bottom border-top text-bold" colspan="9"><?php echo lang('common_tax').': '; echo NumberFormatToCurrency(abs($total_tax)); ?></td>
					</tr>
				<?php }else {?>
				...
				<?php } ?>
                                <tr>
                                    <td class="border-bottom border-top text-bold" colspan="9"><?php echo lang('common_total').': '; echo $this->config->item('round_cash_on_sales') && $is_sale_cash_payment ? NumberFormatToCurrency(round_to_nearest_05(abs($total))) : NumberFormatToCurrency(abs($total)); ?></td>
				</tr>             
