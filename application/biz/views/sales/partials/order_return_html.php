	...
	<div class="w100 clb">
		<table id="pdf_tbl_items" class="w100">
			<tbody>
				...
				<tr>
                                    <td class="border-bottom border-right border-top text-bold" colspan="4" style="text-align: right;">Tổng tiền hàng: </td>
                                    <td class="border-bottom border-left border-top text-bold" colspan="4">1.000.000</td>
                                </tr>
                                <tr>
                                    <td class="border-bottom border-top text-bold border-right" colspan="4" style=" text-align: right;">Tổng tiền :</td>
                                    <td class="border-bottom  border-top border-left  text-bold" colspan="4">1.000.000</td>
				</tr>
                                <tr>
					<!--<td colspan="3"></td>-->
                                    <td colspan="4" class="border-bottom border-top border-right text-bold" style="text-align: right;" >Chiết khấu giảm giá:</td>
                                    <td colspan="4" class="border-bottom border-top  text-bold" style="border-left: none !important;" >10%: 100.000</td>
				</tr>
                                <tr>
                                    <td colspan="4" class="border-bottom border-top border-right text-bold" style="text-align: right;" >Tổng tiền phải trả: </td>
                                    <td colspan="4" class="border-bottom border-top text-bold" style="border-left: none !important;" >900.000</td>
                                </tr>
