						...
						else
						{
						 ...
						 foreach(array_reverse($cart, true) as $line=>$item) { 
							...
							<tr class="register-item-details">
								...
								<td class="text-center">
										<a href="#" class="measure_item" id="measure_<?php echo $line; ?>" class="xeditable" data-type="select"  data-validate-number="true"  data-value="<?php echo isset($item['measure_id']) ? $item['measure_id'] : ''; ?>" data-pk="2" data-source="<?php echo site_url("items/measures/" . $item['item_id']);?>" data-name="measure" data-url="<?php echo site_url('sales/edit_item/'.$line); ?>" data-title="<?php echo lang('common_measure') ?>"><?php echo isset($item['measure_id']) ? $item['measure_id'] : ''; ?></a>
								</td>
