    ...
    <div class="col-md-12">
        <div class="panel panel-piluku">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('item_kits/do_excel_import/', array('id' => 'item_kit_form', 'class' => 'form-horizontal')); ?>
                <h3><?php echo lang('common_step_1'); ?>: </h3>

                <p><?php echo lang('item_kits_step_1_desc'); ?></p>

                <ul class="list-inline">
                    <li>
                        <a class="btn btn-green btn-sm "
                           href="<?php echo site_url('item_kits/excel'); ?>"><?php echo lang('item_kits_new_items_import'); ?></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="btn btn-green btn-sm "
                           href="<?php echo site_url('item_kits/excel_export'); ?>"><?php echo lang('item_kits_update_items_import'); ?></a>
                    </li>
                </ul>

                <h3><?php echo lang('common_step_2'); ?>: </h3>

                <p><?php echo lang('item_kits_step_2_desc'); ?></p>
