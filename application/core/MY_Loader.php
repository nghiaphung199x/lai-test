...
{
	// protected $_ci_view_paths =	array(VIEWPATH	=> TRUE, BIZ_VIEW_PATH => TRUE);
	...
	protected function _ci_load($_ci_data)
	{
		...
		else
		{
			...
			{
				if( $_ci_view_file == VIEWPATH && file_exists(BIZ_VIEW_PATH.$_ci_file)) {
					$_ci_path = BIZ_VIEW_PATH.$_ci_file;
					$file_exists = TRUE;
					break;
				} elseif (file_exists($_ci_view_file.$_ci_file))
				{
	...
	public function helper($helpers = array())
	{
		foreach ($this->_ci_prep_filename($helpers, '_helper') as $helper)
		{
			...
			foreach ($this->_ci_helper_paths as $path)
			{
				if($path == APPPATH && file_exists(BIZ_HELPER_PATH.'/'.$helper.'.php'))
				{
					include_once(BIZ_HELPER_PATH.'/'.$helper.'.php');
					$this->_ci_helpers[$helper] = TRUE;
					log_message('info', 'Helper loaded: '.$helper);
					break;
				} else if (file_exists($path.'helpers/'.$helper.'.php'))
				{
