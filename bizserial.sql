...
--
-- Host: localhost
-- Generation Time: Jun 25, 2016 at 09:47 PM
...
-- Database: `bizserial`
--
CREATE DATABASE IF NOT EXISTS `bizserial` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bizserial`;
...
CREATE TABLE IF NOT EXISTS `phppos_attributes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `filterable` (`filterable`),
  KEY `deleted` (`deleted`),
...
INSERT INTO `phppos_attributes` (`id`, `name`, `code`, `description`, `type`, `sortable`, `filterable`, `required`, `options`, `deleted`) VALUES
(1, 'Name', 'name', 'name', 4, 1, 1, 1, 0x613a313a7b693a323b613a323a7b733a353a226c6162656c223b733a373a2261736461736461223b733a353a2276616c7565223b733a383a227364617364646173223b7d7d, 0);
...
INSERT INTO `phppos_attribute_groups` (`id`, `name`, `description`, `deleted`) VALUES
(1, 'Test', 'Test', 0);
...
--
-- Dumping data for table `phppos_departments`
--

INSERT INTO `phppos_departments` (`department_id`, `name`, `description`, `parent_id`, `path`, `deleted`) VALUES
(1, 'Ban kinh doanh', 'Ban kinh doanh', 0, '/1/', 0),
(2, 'Phòng kinh doanh', 'Phòng kinh doanh', 3, '/3/2/', 0),
(3, 'Ban kỹ thuật', 'Ban kỹ thuật', 0, '/3/', 0),
(4, 'Phòng đào tạo kinh doanh', 'Phòng đào tạo kinh doanh', 3, '/3/4/', 0),
(5, 'Phòng xuất nhập khẩu', 'Phòng xuất nhập khẩu', 4, '/3/4/5/', 0),
(6, 'Phòng ABC', 'Phòng ABC', 5, '/3/4/5/6/', 0);
...
INSERT INTO `phppos_employees` (`id`, `username`, `password`, `force_password_change`, `person_id`, `group_id`, `department_id`, `language`, `commission_percent`, `commission_percent_type`, `hourly_pay_rate`, `inactive`, `reason_inactive`, `hire_date`, `employee_number`, `birthday`, `termination_date`, `deleted`) VALUES
(1, 'admin', '25d55ad283aa400af464c76d713c07ad', 0, 1, 2, 6, 'vietnam', '0.0000000000', 'selling_price', '0.0000000000', 0, NULL, NULL, NULL, NULL, NULL, 0);
...
INSERT INTO `phppos_giftcards` (`giftcard_id`, `giftcard_number`, `description`, `value`, `customer_id`, `inactive`, `deleted`) VALUES
(1, 'Test', 'Test', '23332132.0000000000', NULL, 0, 0);
...
INSERT INTO `phppos_giftcards_log` (`id`, `log_date`, `giftcard_id`, `transaction_amount`, `log_message`) VALUES
(1, '2016-06-01 07:14:48', 1, '23332132.0000000000', 'Lan Nguyễn Thẻ quà tặng được tạo ra với một giá trị của 23.332.132 VNĐ');

-- --------------------------------------------------------

--
-- Table structure for table `phppos_groups`
--
...
(2, 'Admin', 'Admin', 0),
(3, 'Employee', 'Employee', 0);

-- --------------------------------------------------------

--
-- Table structure for table `phppos_group_permissions`
--
...
--
-- Dumping data for table `phppos_group_permissions`
--

INSERT INTO `phppos_group_permissions` (`module_id`, `group_id`) VALUES
('attribute_groups', 2),
('attribute_sets', 2),
('attributes', 2),
('config', 2),
...
--
-- Table structure for table `phppos_group_permissions_actions`
--
...
--
-- Dumping data for table `phppos_group_permissions_actions`
--

INSERT INTO `phppos_group_permissions_actions` (`module_id`, `group_id`, `action_id`) VALUES
('attribute_groups', 2, 'add_update'),
('attribute_groups', 2, 'delete'),
('attribute_groups', 2, 'search'),
('attribute_sets', 2, 'add_update'),
('attribute_sets', 2, 'delete'),
('attribute_sets', 2, 'search'),
('attributes', 2, 'add_update'),
('attributes', 2, 'delete'),
('attributes', 2, 'search'),
...
('customers', 3, 'delete'),
('customers', 3, 'edit_customer_points'),
('customers', 3, 'edit_store_account_balance'),
('customers', 3, 'search'),
('departments', 2, 'add_update'),
('departments', 2, 'delete'),
('departments', 2, 'search'),
...
CREATE TABLE IF NOT EXISTS `phppos_modules` (
  ...
  `module_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `main_menu` tinyint(1) unsigned NOT NULL DEFAULT '1',
...
('module_attribute_groups', 'module_attribute_group_desc', 30, 'setting', 'attribute_groups', 1),
('module_attribute_sets', 'module_attribute_sets_desc', 30, 'settings', 'attribute_sets', 1),
('module_attributes', 'module_attributes_desc', 45, 'setting', 'attributes', 1),
('module_config', 'module_config_desc', 100, 'settings', 'config', 1),
('module_customers', 'module_customers_desc', 10, 'user', 'customers', 1),
('module_departments', 'module_departments_desc', 300, 'location-pin', 'departments', 0),
('module_employees', 'module_employees_desc', 80, 'id-badge', 'employees', 1),
('module_expenses', 'module_expenses_desc', 75, 'money', 'expenses', 1),
('module_giftcards', 'module_giftcards_desc', 90, 'credit-card', 'giftcards', 1),
('module_groups', 'module_groups_desc', 100, 'user', 'groups', 0),
('module_item_kits', 'module_item_kits_desc', 30, 'harddrives', 'item_kits', 1),
('module_items', 'module_items_desc', 20, 'harddrive', 'items', 1),
('module_locations', 'module_locations_desc', 110, 'home', 'locations', 1),
('module_messages', 'module_messages_desc', 120, 'email', 'messages', 1),
('module_receivings', 'module_receivings_desc', 60, 'cloud-down', 'receivings', 1),
('module_reports', 'module_reports_desc', 50, 'bar-chart', 'reports', 1),
('module_sales', 'module_sales_desc', 70, 'shopping-cart', 'sales', 1),
('module_suppliers', 'module_suppliers_desc', 40, 'download', 'suppliers', 1);
...
('add_update', 'departments', 'module_action_add_update', 2),
...
('delete', 'departments', 'module_action_delete', 3),
...
('search', 'departments', 'module_action_search_departments', 1),
...
('customers', 1, 'search'),
('departments', 1, 'add_update'),
('departments', 1, 'delete'),
('departments', 1, 'search'),
...
(1, 1, );
...
('247649ecf5f544b82a1b0802d196e376d95b1c6d', '127.0.0.1', 1466787944, 0x706572736f6e5f69647c733a313a2231223b6b6565705f616c6976657c693a313436363738373934343b637573746f6d65727c693a2d313b),
('293afac9234ba75b2b3163cd4ebeec528485e1ec', '127.0.0.1', 1465409571, 0x706572736f6e5f69647c733a313a2231223b6b6565705f616c6976657c693a313436353430393537313b),
('79a3e1beb676e4880119d5cb48c9188995abef5b', '127.0.0.1', 1465640208, 0x706572736f6e5f69647c733a313a2231223b6b6565705f616c6976657c693a313436353634303230383b),
('7fab014f95662b732ef01d62caeb8ad6e0dc468d', '127.0.0.1', 1465503183, 0x706572736f6e5f69647c733a313a2231223b6b6565705f616c6976657c693a313436353530333138333b),
('97d8b200d41a9251284ae3471551ed24eb55ce86', '127.0.0.1', 1466748650, 0x706572736f6e5f69647c733a313a2231223b6b6565705f616c6976657c693a313436363734383635303b),
('a97a8d2d820f15a4980c0792204ac570c72f99cb', '127.0.0.1', 1464983639, 0x706572736f6e5f69647c733a313a2231223b6b6565705f616c6976657c693a313436343938333633393b),
('aa210ba36d819e788bfd32a01589096f8bc053d8', '127.0.0.1', 1465088195, 0x706572736f6e5f69647c733a313a2231223b6b6565705f616c6976657c693a313436353038373935373b),
('e3967e6fdf7a0a6683ff79c39f0610d241aa9c3b', '127.0.0.1', 1466701691, 0x706572736f6e5f69647c733a313a2231223b6b6565705f616c6976657c693a313436363730313639313b);
...
ALTER TABLE `phppos_register_log_audit`
  ADD CONSTRAINT `phppos_register_log_audit_ibfk_1` FOREIGN KEY (`register_log_id`) REFERENCES `phppos_register_log` (`register_log_id`),
  ADD CONSTRAINT `phppos_register_log_audit_ibfk_2` FOREIGN KEY (`employee_id`) REFERENCES `phppos_employees` (`person_id`);
